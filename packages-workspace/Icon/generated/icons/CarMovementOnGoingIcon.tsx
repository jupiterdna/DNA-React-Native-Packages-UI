...
const wrapper = (props: Props) => {
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M6.676 15.84a5.678 5.678 0 100-11.356 5.678 5.678 0 000 11.356zm1.44-2.87l-2.19-2.188v-3.63h1.5v3.008l1.75 1.75-1.06 1.06z" />
...
const CarMovementOnGoingIcon = ({ size = 24, ...iprops }: Props) => {
  const newProps = {
    ...iprops,
    width: size,
    height: size,
...
export default CarMovementOnGoingIcon;
