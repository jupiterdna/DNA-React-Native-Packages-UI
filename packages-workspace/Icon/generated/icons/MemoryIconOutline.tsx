...
const wrapper = (props: Props) => {
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M14.875 9.125h-5.75v5.75h5.75v-5.75zm-4.25 4.25v-2.75h2.75v2.75h-2.75z" />
...
const MemoryIconOutline = ({ size = 24, ...iprops }: Props) => {
  const newProps = {
    ...iprops,
    width: size,
    height: size,
...
export default MemoryIconOutline;
