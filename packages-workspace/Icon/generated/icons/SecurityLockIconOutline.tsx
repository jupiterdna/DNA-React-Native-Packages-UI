...
const wrapper = (props: Props) => {
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M9.256 9.048a2.744 2.744 0 015.488 0v1.345h.229c.69 0 1.25.56 1.25 1.25v4.396c0 .69-.56 1.25-1.25 1.25H9.029c-.69 0-1.25-.56-1.25-1.25v-4.396c0-.69.56-1.25 1.25-1.25h.227V9.048zm3.988 0a1.244 1.244 0 10-2.488 0v1.345h2.488V9.048z" />
...
const SecurityLockIconOutline = ({ size = 24, ...iprops }: Props) => {
  const newProps = {
    ...iprops,
    width: size,
    height: size,
...
export default SecurityLockIconOutline;
