...
const wrapper = (props: Props) => {
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M4.744 12.3h12.75v1.5H4.744v-1.5zM9.5 10.45H4.75V7.2H9.5v3.25z" />
...
const CreditCardNumberIconOutline = ({ size = 24, ...iprops }: Props) => {
  const newProps = {
    ...iprops,
    width: size,
    height: size,
...
export default CreditCardNumberIconOutline;
