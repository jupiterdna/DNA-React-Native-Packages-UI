    ...
    <>
      {!state?.open && (
        <>
          <button
            onClick={handleClick}
            className="fixed right-4 cursor-pointer rounded-full  border-none shadhow-md w-[40px] h-[40px]"
          >
      ...
      <div
        className={`relative bg-gray-200 dark:bg-gray-900 ${styleCls} h-[90vh]`}
      >
        <button
          onClick={handleClick}
          className="border-none -left-6 absolute bg-white rounded-full shadow-lg w-[40px] h-[40px] mt-2"
        >
