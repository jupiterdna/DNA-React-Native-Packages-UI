...
const wrapper = (props: Props) => {
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M8.465 15.755h2.785v2.785h1.5v-2.785h2.786v-1.5H12.75v-2.786h-1.5v2.786H8.465v1.5z" />
...
const SaveNewIconOutline = ({ size = 24, ...iprops }: Props) => {
  const newProps = {
    ...iprops,
    width: size,
    height: size,
...
export default SaveNewIconOutline;
